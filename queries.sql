...
SELECT M.Id_mensa, M.Nome_mensa, M.Tempo_sevizio, F.N_persone FROM MENSE M INNER JOIN FOTO F ON M.Id_mensa=F.Id_mensa AND F.Data = (SELECT MIN(Data) FROM FOTO F WHERE F.Id_mensa=$1);
