...
namespace CrowdVision.App_Start
{
    ...
    public static class PodMonitorConfig
    {
        ...
        public static StringWriter outText;
        public static void Start()
        {
            outText = new StringWriter();
            Console.SetOut(outText);
            m_job = new PodMonitorJob(TimeSpan.FromSeconds(5));
        }
...
namespace CrowdVision.Pooler
{
    ...
    static class Pooler
    {
        ...
        {
            connstring = ConfigurationManager.AppSettings["postgreConnString"];
        ...
        public static void ProcessTick()
        {
            ...
            string[] files = ConfigurationManager.AppSettings["IDMense"].Split('|');
